  ...
  <summary>Alarm</summary>
    <table style="border-collapse: collapse;">
        ...
        <tbody style="white-space: pre; color: white;">
            <tr>
                <td style="border: 1px solid">Get</td>
                <td style="border: 1px solid">api/user/:userId/alarm</td>
            ...
            <tr>
                <td style="border: 1px solid">Post</td>
                <td style="border: 1px solid">api/alarm</td>
            ...
            <tr>
                <td style="border: 1px solid">Patch</td>
                <td style="border: 1px solid">api/alarm/:alarmId</td>
  ...
  <summary>Article</summary>
    <table style="border-collapse: collapse;">
        ...
        <tbody style="white-space: pre; color: white;">
            <tr>
                <td style="border: 1px solid">Get</td>
                <td style="border: 1px solid">api/article?<br/>offset=10&&emsp;//pagination offset<br/>limit=5&&emsp;//pagination limit<br/>order=0&&emsp;//0 is ascending, 1 is descending<br/>order_type=post_at&&emsp;//or like_count, comment_count<br/>id=3,5,6&&emsp;//article id list<br/>blog_id=15,20&&emsp;//blog id list<br/>keyword='good'&emsp;//to search article including keyword in content or title</td>
                <td style="border: 1px solid"></td>
            ...
            <tr>
                <td style="border: 1px solid">Post</td>
                <td style="border: 1px solid">api/article</td>
            ...
            <tr>
                <td style="border: 1px solid">Put</td>
                <td style="border: 1px solid">api/article/:articleId</td>
            ...
            <tr>
                <td style="border: 1px solid">Get</td>
                <td style="border: 1px solid">api/blog/:blogId/article?<br/>offset=10&&emsp;//pagination offset<br/>limit=5&&emsp;//pagination limit<br/>order=0&&emsp;//0 is ascending, 1 is descending<br/>posted=1&&emsp;//0 means in progres<br/>category_id=5&<br/>min_article_id=10&&emsp;<br/>max_article_id=30&emsp;</td>
                <td style="border: 1px solid"></td>
            ...
            <tr>
                <td style="border: 1px solid">Post</td>
                <td style="border: 1px solid">api/article/:articleId/showed</td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">Permit all</td>
            </tr>
  ...
  <summary>Article great</summary>
    <table style="border-collapse: collapse;">
        ...
        <tbody style="white-space: pre; color: white;">
            <tr>
                <td style="border: 1px solid">Get</td>
                <td style="border: 1px solid">api/article/great?<br/>user_id=217&&emsp;<br/>article_id=817</td>
                <td style="border: 1px solid"></td>
            ...
            <tr>
                <td style="border: 1px solid">Post</td>
                <td style="border: 1px solid">api/article/great</td>
            ...
            <tr>
                <td style="border: 1px solid">Patch</td>
                <td style="border: 1px solid">api/article/:greatId</td>
            ...
            <tr>
                <td style="border: 1px solid">Delete</td>
                <td style="border: 1px solid">api/article/great/:greatId</td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">the user_id of the great and authenticated user_id must be equal</td>
            </tr>
