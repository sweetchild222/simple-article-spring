    ...
    <table style="border-collapse: collapse;">
        ...
        <thead style="background-color:gray; color:lightGray;">
            <tr>                
                ...
                <th style="border: 1px solid">Request payload example</th>
                <th style="border: 1px solid">Response payload example</th>
                <th style="border: 1px solid">Access constraint</th>
            </tr>
        </thead>
        <tbody style="white-space: pre; color: white;">
            <tr>                
                <td style="border: 1px solid;">Get api/user/:userId/alarm</td>
                ...
                <td style="border: 1px solid">the userId and authenticated user_id must be equal</td>
            </tr>
            <tr>                
                <td style="border: 1px solid">Post api/alarm</td>
                <td style="border: 1px solid">{<br/>&emsp;to_user_id: 3,<br/>&emsp;from_user_id: 10,<br/>&emsp;type: 'COMMENT',&emsp;//'REPLY', 'MENTION' <br/>&emsp;comment_id: 15<br/>}</td>
                <td style="border: 1px solid">{<br/>&emsp;id: 30&emsp;//created alarm id<br/>}</td>
                <td style="border: 1px solid">the from_user_id and authenticated user_id must be equal</td>
            </tr>
            <tr>                
                <td style="border: 1px solid">Patch api/alarm/:alarmId</td>
                <td style="border: 1px solid">{<br/>&emsp;checked: 1,&emsp;//or 0<br/>}</td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">the to_user_id of the alarm and authenticated user_id must be equal</td>
            </tr>
            <tr>                
                <td style="border: 1px solid">Delete api/alarm/:alarmId</td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">the to_user_id of the alarm and authenticated user_id must be equal</td>
            </tr>
...
<details>
  <summary>Article</summary>
    <table style="border-collapse: collapse;">
        ...
        <tbody style="white-space: pre; color: white;">
            <tr>                
                <td style="border: 1px solid">Get api/article?<br/>offset=10&&emsp;//pagination offset<br/>limit=5&&emsp;//pagination limit<br/>order=0&&emsp;//0 is ascending, 1 is descending<br/>order_type=post_at&&emsp;//or like_count, comment_count<br/>id=3,5,6&&emsp;//article id list<br/>blog_id=15,20&&emsp;//blog id list<br/>keyword='good'&emsp;<br/>//keywoard to search  in content or title</td>
                <td style="border: 1px solid"></td>
            ...
            <tr>                
                <td style="border: 1px solid">Post api/article</td>
            ...
            <tr>                
                <td style="border: 1px solid">Put api/article/:articleId</td>
            ...
            <tr>                
                <td style="border: 1px solid">Delete api/article/:articleId</td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid"></td>
            ...
            <tr>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">Get api/blog/:blogId/article?<br/>offset=10&&emsp;//pagination offset<br/>limit=5&&emsp;//pagination limit<br/>order=0&&emsp;//0 is ascending, 1 is descending<br/>posted=1&&emsp;//0 means in progres<br/>category_id=5&<br/>min_article_id=10&&emsp;<br/>max_article_id=30&emsp;</td>
                <td style="border: 1px solid"></td>
            ...
            <tr>                
                <td style="border: 1px solid">Post api/article/:articleId/showed</td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">Permit all</td>
            </tr>
  ...
  <summary>Article great</summary>
    <table style="border-collapse: collapse;">
        ...
        <tbody style="white-space: pre; color: white;">
            <tr>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">Get api/article/great?<br/>user_id=217&&emsp;<br/>article_id=817</td>
                <td style="border: 1px solid"></td>
            ...
            <tr>                
                <td style="border: 1px solid">Post api/article/great</td>
            ...
            <tr>                
                <td style="border: 1px solid">Patch api/article/:greatId</td>
            ...
            <tr>                
                <td style="border: 1px solid">Delete api/article/great/:greatId</td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid"></td>
                <td style="border: 1px solid">the user_id of the great and authenticated user_id must be equal</td>
            </tr>
